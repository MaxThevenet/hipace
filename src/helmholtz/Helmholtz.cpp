...
void
Helmholtz::AdvanceSliceMGGenesis (amrex::Real dt, int step)
{

    HIPACE_PROFILE("Helmholtz::AdvanceSliceMGGenesis()");
...
void
Helmholtz::AdvanceSliceFFTGenesisRed (const amrex::Real dt, int step)
{
